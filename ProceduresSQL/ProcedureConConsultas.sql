...
UPDATE tabla_de_productos SET PRECIO_DE_LISTA=5 WHERE NOMBRE_DEL_PRODUCTO
LIKE 'Sabor Al%';

SELECT * FROM tabla_de_productos WHERE NOMBRE_DEL_PRODUCTO LIKE 'Sabor Al%';

DELETE FROM tabla_de_productos WHERE NOMBRE_DEL_PRODUCTO LIKE 'Sabor Al%';
